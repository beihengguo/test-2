...
const ALPINE_DARK_BLUE = "#0a4e88";
const MUI_PRIMARY = "#0d61a7";
...
const CATEGORIES = [
  {
    ...
    description:
      "Ductless mini-split air conditioning systems for homes without ductwork, room additions, or zoned cooling.",
    href: "#ductless",
    browseLabel: "Browse In Stock Systems",
  },
  {
    id: "next-gen-ducted",
    ...
    description:
      "Ducted HVAC systems for whole-home heating and cooling using existing ductwork.",
    href: "#ducted",
    browseLabel: "Browse In Stock Systems",
  },
  {
    ...
    description:
      "Central air conditioners and heat pumps for reliable whole-home cooling and heating.",
    href: "#central-air",
    browseLabel: "Browse In Stock Systems",
  },
  {
    ...
    description:
      "Complete heating and cooling systems with matched indoor and outdoor units for full-home comfort.",
    href: "#complete-hvac",
    browseLabel: "Browse In Stock Systems",
  },
  {
    ...
    title: "PTAC Units",
    description:
      "Packaged terminal air conditioners ideal for hotels, apartments, and room-by-room cooling.",
    href: "#ptac",
    browseLabel: "Browse In Stock Systems",
  },
  {
    ...
    description:
      "All-in-one packaged HVAC units for rooftop or ground installation in residential or commercial spaces.",
    href: "#packaged",
    browseLabel: "Browse In Stock Systems",
  },
  {
    ...
    description:
      "Wall-mounted heating and cooling units for apartments, hotels, and room additions.",
    href: "#wall-mounted",
    browseLabel: "Browse In Stock Systems",
  },
  {
    id: "installation-supplies",
    chip: null,
    title: "Installation Supplies",
    description:
      "HVAC installation supplies including line sets, disconnect boxes, pads, and essential components.",
    href: "#supplies",
    browseLabel: "Browse Supplies & Components",
  },
  {
    id: "scratch-dent",
    chip: null,
    title: "Scratch & Dent Deals",
    description:
      "Discounted HVAC systems with minor cosmetic imperfections, fully functional and ready to install.",
    href: "#scratch-dent",
    browseLabel: "View Deals",
  },
];
...
function HeroSection() {
  return (
    ...
    >
      <Container maxWidth={false} disableGutters sx={{ maxWidth: 960 }}
...
function TrustBar() {
  return (
    ...
    >
      <Container maxWidth={false} disableGutters sx={{ maxWidth: 960, mx: "auto", px: 3 }} disableGutters>
        <Stack
          direction={{ xs: "column", sm: "row" }}
          spacing={{ xs: 1.5, sm: 3 }}
          alignItems="center"
...
function ShoppingAssistanceSection() {
  ...
  return (
    <Box
      ...
      sx={{ width: "100%" }}
    >
      <Container maxWidth={false} disableGutters sx={{ maxWidth: 960, mx: "auto", px: 3 }}>
 ...
 */
function CategoryCard({ chip, title, description, href, browseLabel }) {
  return (
    <Card
      variant="outlined"
      sx={{
    ...
    >
      ...
      >
        {/* Chip badge — only render if present */}
        {chip && (
          <Box>
            <Chip
              label={chip}
